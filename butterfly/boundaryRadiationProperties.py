# coding=utf-8
"""boundaryRadiationProperties class."""
from foamfile import FoamFileZeroFolder, foam_file_from_file
from collections import OrderedDict


class BoundaryRadiationProperties(FoamFileZeroFolder):
    """boundaryRadiationProperties class."""

    # set default valus for this class
    __default_values = OrderedDict()
    __default_values['dimensions'] = '[0 0 0 0 0 0 0]'
    __default_values['internalField'] = 'uniform 0'
    # __default_values['boundaryField'] = None

    def __init__(self, values=None):
        """Init class."""
        FoamFileZeroFolder.__init__(self, name='boundaryRadiationProperties',
                                    cls='dictionary',
                                    location='constant',
